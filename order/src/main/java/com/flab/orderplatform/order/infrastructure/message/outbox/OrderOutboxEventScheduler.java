...
public class OrderOutboxEventScheduler {

    @Qualifier("orderOutboxEventProcessor")
    ...
    @SchedulerLock(name = "orderPublishOutboxEvents", lockAtLeastFor = "10s", lockAtMostFor = "50s")
    ...
    @SchedulerLock(name = "orderDeletePublishedOutboxEvents", lockAtLeastFor = "10s", lockAtMostFor = "1h")
