...
public class PaymentOutboxEventScheduler {
    ...
    @Qualifier("paymentOutboxEventProcessor")
    ...
    @SchedulerLock(name = "paymentPublishOutboxEvents", lockAtLeastFor = "10s", lockAtMostFor = "50s")
    ...
    @SchedulerLock(name = "paymentDeletePublishedOutboxEvents", lockAtLeastFor = "10s", lockAtMostFor = "1h")
